function! foldtext#Konfekt#description()
    return "No of lines and percentage right-aligned"
endfunction

if !exists('g:foldtext_konfekt_delim')
    let g:foldtext_konfekt_delim = ' '
endif

" Modification of https://github.com/chrisbra/vim_dotfiles/blob/master/plugin/CustomFoldText.vim
" Always show some delimiters (|g:foldtext_konfekt_delim|) and the tail of
" the folded line, that is, the number of lines folded (absolute and relative)
function! foldtext#Konfekt#foldtext()
    ...
    let expansionString = repeat(g:foldtext_konfekt_delim, lengthMiddle)
